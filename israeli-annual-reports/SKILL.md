...
- Sec. 114-118 (Chapter Three, Sign J, ועדת ביקורת): Audit-committee requirements. A public company's board, and the board of a private bond company, appoints an audit committee from among its directors (Sec. 114); Sec. 115 sets its composition
- Sec. 270-275 (Chapter Five, עסקאות עם בעלי ענין): Related-party transaction approvals (cross-reference IAS 24 disclosure)
