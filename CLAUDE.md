...
This is a Skills IL category repository containing AI agent skills for Israeli accounting, bookkeeping, and financial management. Each subdirectory is a self-contained skill following the open Agent Skills standard.
...
├── israeli-bank-reconciliation/      # Skill: Israeli Bank Reconciliation
│   ├── SKILL.md                     # Required skill definition
│   └── SKILL_HE.md                  # Hebrew version
├── israeli-receipt-scanner/          # Skill: Israeli Receipt Scanner
│   └── SKILL.md
├── CLAUDE.md                         # This file
├── LICENSE                           # MIT
