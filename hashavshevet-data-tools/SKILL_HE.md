...
כללי אימות ייבוא:
- מספרי חשבון חייבים להופיע במטקונת החשבונות
...
**מעבר ל-iCount:**
- תייצאו את מטקונת החשבונות ואז תמפו מספרי חשבון לקטגוריות iCount
...
פעולות:
1. קריאה ופענוח של `HESHIN.dat` (מטקונת חשבונות) ו-`MATZAV.dat` (יתרות חשבונות) מחשבשבת
...
סיבה: פקודות יומן מתייחסות לחשבונות שנמחקו או שמספרם השתנה בחשבשבת, או שייצוא מטקונת החשבונות הוא משנת מס אחרת מפקודות היומן.
פתרון: תייצאו את מטקונת החשבונות ואת פקודות היומן מאותו בסיס נתונים ושנת מס בחשבשבת. אם חשבונות מוספרו מחדש, תיצרו טבלת מיפוי ותעדכנו הפניות לפני הייבוא. תבדקו אם אפסים מובילים הוסרו תוך כדי ההמרה.
