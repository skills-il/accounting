...
compatibility: Requires Node.js 18+ and the Google Workspace CLI (npm install -g @googleworkspace/cli). Requires Google OAuth setup via gws auth login. Works with Claude Code, Cursor, GitHub Copilot, Windsurf, OpenCode, and Codex.
---
