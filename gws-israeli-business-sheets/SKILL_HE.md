...
כאן יושבים שני כללים שונים, והערבוב ביניהם הוא הטעות הקלאסית. **חובת המוכר** להוציא מספר היא סעיף 47(א2)(1), שקמה לפי דרישת הקונה ואינה חלה על חשבונית בשיעור אפס, ולכן היא תלויה ב: הסכום עולה על הסף של אותו תאריך, החשבונית אינה בשיעור אפס או פטורה בלבד, המקבל הוא עוסק מורשה, והקונה דרש. **שלילת הניכוי אצל הקונה** היא סעיף 38(א1) ואין לה תנאי של דרישת הקונה: "לא יותר ניכוי מס התשומות הכלול בחשבונית מס שסכומה, בלא המס, עולה על 5,000 שקלים חדשים ... ושאינה כוללת מספר שהקצה לה המנהל". לכן כשבודקים את הגיליון, אל תתייחסו ל"הקונה לא ביקש" כאישור: סמנו כל שורה מעל הסף של אותו תאריך שיש בה מע"מ ועמודה K שלה ריקה, כי המקבל מפסיד את הניכוי כך או כך. שימו לב שהחוק כותב "עולה על", כך ששורה בדיוק בגובה הסף אינה בתחולה. שורות בשיעור אפס וייצוא נשארות בחוץ. המספר בן 9 ספרות, והיעדרו חוסם את קיזוז מס התשומות אצל המקבל בלי להפוך את החשבונית לבטלה.
