...
עמודה K שומרת את **מספר ההקצאה** שהמוכר מוציא מפלטפורמת חשבוניות ישראל של רשות המיסים. **הסף שבתוקף כיום הוא 5,000 ש"ח ומעלה (לפני מע"מ), החל מ-1 ביוני 2026.** הסף ירד במהלך 2026: 10,000 ש"ח מ-1 בינואר, ואז 5,000 ש"ח מ-1 ביוני. השתמשו בסכום העדכני של 5,000 ולא בזה של ינואר. בלי מספר ההקצאה הקונה לא יכול לקזז מע"מ תשומות על החשבונית, אז תתפסו אותו בכל פעם שזה רלוונטי, ובדקו מחדש את הסף לפני שמצטטים אותו כי הוא הורד כמה פעמים.
...
מספר הקצאה ומנדט החשבונית הדיגיטלית. מודל הבקרה הרציפה של ישראל מחייב מספר הקצאה מפלטפורמת רשות המיסים לחשבוניות מס מסכום סף ומעלה, לפני שהקונה יכול לקזז מע"מ תשומות. **הסף שבתוקף כיום הוא 5,000 ש"ח ומעלה (לפני מע"מ), החל מ-1 ביוני 2026** (הוא היה 10,000 ש"ח מ-1 בינואר 2026). כשרושמים חשבונית בסכום הזה ומעלה, תזכירו למשתמש להוציא את מספר ההקצאה דרך תוכנת החשבוניות שלו ולרשום אותו לצד מספר החשבונית. הסף הורד פעמיים כבר ב-2026, אז ודאו את הסכום העדכני במקום להסתמך על מספר זכור.
