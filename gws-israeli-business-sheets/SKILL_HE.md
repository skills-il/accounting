...
- תקופות דיווח מע"מ בישראל הן דו-חודשיות (כל חודשיים), לא רבעוניות כמו במדינות רבות אחרות. סוכנים עלולים לבנות סיכומים על בסיס רבעוני, שלא מתאים לדרישות רשות המיסים.
- פורמט התאריך הישראלי הוא DD/MM/YYYY, לא MM/DD/YYYY. סוכנים עלולים להשתמש בפורמט האמריקאי, מה שגורם לבלבול כשתאריכים כמו 03/04/2026 יכולים להיות 3 באפריל או 4 במרץ.
- הוצאות ארוחות ואירוח מוכרות רק ב-80% בישראל. סוכנים עלולים לסווג אותן כמוכרות ב-100%, מה שמנפח ניכויי מס.
