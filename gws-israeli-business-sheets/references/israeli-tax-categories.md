...
## Depreciable Assets (Capitalize, Not 100% Immediate)

Equipment such as computers, monitors, and office furniture is a **depreciable asset (נכס בר-פחת)**, not a 100%-in-year-one expense. Capitalize the purchase and deduct it through depreciation (פחת) spread over the asset's useful life, not as a single first-year expense.
...
| Gifts over 240 NIS | מתנות מעל 240 ש"ח | Per recipient per year (ceiling raised from 210 to 240 in January 2024) |
...
Note on Form 126: Form 126 is the annual employer-withholding reconciliation for **salaried employees**. A self-employed business with no employees does not file it. Form 856 (annual summary of amounts withheld from suppliers) is the one relevant to a typical freelancer who withholds, or whose clients withhold, at source.
