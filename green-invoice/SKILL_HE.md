...
- החל מיוני 2026, חשבוניות מס B2B מעל 5,000 ש"ח דורשות מספר הקצאה (שע"מ) מרשות המסים. חשבונית ירוקה מטפלת באינטגרציית שע"מ באופן פנימי לסוגי מסמכים נתמכים, אבל סוכנים צריכים להתריע למשתמשים על דרישה זו ביצירת חשבוניות B2B גדולות. סקיל זה לא מכסה תאימות שע"מ ישירות (השתמשו ב-israeli-e-invoice לכך).
