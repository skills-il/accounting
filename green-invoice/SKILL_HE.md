...
| מערכת חשבוניות ישראל (שע"מ) | https://www.gov.il/he/service/invoice-allocation-number | דרישות מספר הקצאה לחשבוניות B2B מעל 5,000 ש"ח |
...
- החל מיוני 2026, חשבוניות מס B2B מעל 5,000 ש"ח דורשות מספר הקצאה (שע"מ) מרשות המסים. חשבונית ירוקה מטפלת באינטגרציית שע"מ באופן פנימי בסוגי המסמכים הנתמכים, אבל סוכנים צריכים להתריע למשתמש על הדרישה הזו ביצירת חשבוניות B2B גדולות. הסקיל הזה לא מכסה תאימות שע"מ ישירות (לזה יש את israeli-e-invoice).
